    ...
    return (
      <div className="w-full bg-white ">
        <div className="w-full h-[2800px]">
          ...
          <div>
            <Image src='/section1_shop2.png' alt="Placeholder Image" width={1440} height={100}/>
          </div>
          <div>
          <Link href="./shop/singleShop"><Image src='/section1_shop3.png' alt="photo" width={1440} height={100}/></Link>
          </div>
          <div>
