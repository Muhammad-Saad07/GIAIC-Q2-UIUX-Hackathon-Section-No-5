...
export default function SingleShop() {
    return (
      <div className="w-full bg-white ">
        <div className="w-full h-[2200px]">
          <div>
            <Image className="h-[316px]" src='/section1_shop1.png' alt="photo" width={1440} height={700}/>
          </div>
          <div>
            <Image src='/singleshop_1.png' alt="Photo" width={1440} height={100}/>
          </div>
          <div>
          <Link href="/comparison/"><Image src='/singleshop_2.png' alt="photo" width={1440} height={100}/></Link>
          </div>
          <div>
          <Image src='/singleshop_3.png' alt="photo" width={1440} height={100}/>
          </div>
